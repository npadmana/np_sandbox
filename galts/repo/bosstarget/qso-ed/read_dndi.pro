...
;      read_dndi
;   PURPOSE:
;      read the files with the differential number counts/sq. deg.
;   INPUT:
;      filename - the name of the file that holds the number counts
;   KEYWORDS:
...
;   OUTPUT:
;      i - i band magnitude
;      dndi - differential number counts /sq. deg.
;   HISTORY:
